    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('autor', models.ManyToManyField(to='segundo_app.autor')),
                ('categoria', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, to='segundo_app.categoria', verbose_name='Categoria')),
            ],
            options={
